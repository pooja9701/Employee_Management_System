       ...
       <td><%=result.getString(3)%></td>
        <td><%=result.getString(2)%></td>
         <td><%=result.getString(4)%></td>
            ...
            <%--      <td><a href="<%=request.getContextPath()%>/PDF?e=<%=result.getString(2)%>&p=<%=result.getString(3)%>&gs=<%=result.getString(4)%>&e=<%=%>&d=<%=result.getString(5)%>&t=<%=result.getString(6)%>">Download PDF</a></td>
 --%>      </tr>
		<% 
